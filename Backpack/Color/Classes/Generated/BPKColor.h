 ...
 *
 * <div style="width: 100px; height: 100px; background: #cbeef5ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 ...
 *
 * <div style="width: 100px; height: 100px; background: #b0e4eeff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #7fd7e8ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #40c4dfff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #e1f4f8ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #00b2d6ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #009dbdff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #008ca8ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #00758cff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #005567ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #e6e4ebff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ccc9d4ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #b2aebdff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #9a95a7ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #f3f2f5ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #817b8fff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #696179ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #524c61ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #3b344bff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #252033ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #cbf5e2ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #afedd1ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #80e8b9ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #40de97ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #dff7ecff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #00d775ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #00bd68ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #00a85dff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #008c4dff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #006638ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ffbfd7ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ff94bbff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ff73a6ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ff619bff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #fde4edff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #fa488aff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #d92b6bff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #c50f52ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #b00c48ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #94053aff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #02ddd8ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ffd6d5ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ffbbbaff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ff9694ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #fe7471ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #fcf2f2ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ff5452ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #eb423fff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #de322fff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #cc1f1dff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #a80300ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ffffffff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #fff3cfff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ffecb8ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ffe18cff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ffcf4aff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #fff9e6ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #ffbb00ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #f0b000ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #e1a500ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #c28e00ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
 ...
 *
 * <div style="width: 100px; height: 100px; background: #9c7200ff; box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3);
 * border-radius: 6px;"></div>
 */
